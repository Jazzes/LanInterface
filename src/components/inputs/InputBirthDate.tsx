...
import img from "../../static/photos/birthdaydAte.svg";
...
const InputBirthDate = () => {
    ...
    return (
        <div className={styles.container + (isValid === false ? " " + styles.containerNotValid : "") + (isValid === true ? " " + styles.containerValid : "")}
             style={{marginLeft: 40, marginTop: 35}} onMouseLeave={() => setFocused(false)}>
            <img src={img} alt=""/>
            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.row}>
                    <input ref={ref} value={value} onChange={() => {
                           ...
                           onFocus={() => setFocused(true)} type="text" name="dateBirth" placeholder="1 января 2000"
                           className={styles.input} autoComplete={"off"} required={true}/>
                ...
                <div className={styles.list + (focused ? " " + styles.listOpened : "")}>
                        <div className={styles.listItem} onClick={() => {
                            setValue(`1 января 2000`)
                            setFocused(false)
                            setIsValid(true)
                        }}>
                            Календарь (кликни на меня)
                        </div>
                </div>
